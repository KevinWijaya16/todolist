...
<body class="flex flex-col justify-center items-center p-12 bg-[#E7E8EA] relative overflow-hidden">
    ...
    <img src="{{ asset('img/Group 9.png') }}" alt="logo" width="100" height="100" class="w-[90px] h-[90px] rounded-full">
    ...
    <form action="/store" method="POST" class="flex flex-col gap-3 w-full max-w-md mb-4 mt-3">
        @csrf
        <input type="text" name="title" class="h-12 w-full py-2 px-4 border border-gray-200 rounded-full focus:outline-none focus:ring-1 focus:ring-black bg-white shadow-md" placeholder="Add your task here" required>
        ...
        <button type="submit" class="h-12 px-5 rounded-full shadow-md focus:ring-1 focus:ring-black font-semibold bg-blue-500 text-white hover:bg-blue-600 transition">ADD</button>
    </form>
